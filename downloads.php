...
<?php
	...
	$empSQL = "SELECT id,name, size, downloads, created 
	FROM `files` LIMIT $startFrom, $showRecordPerPage";
...
<tbody>
  ...
  <?php foreach ($files as $file): 
    ...
    <tr>
      ...
      <div class="mb-3">
      <td><a href="downloads.php?file_id=<?php echo $file['id'] ?>"><button type="submit" class="btn btn-primary btn-sm mr-20" name="save">Download</button></a></td>
    </tr>
  <?php endforeach;?>
